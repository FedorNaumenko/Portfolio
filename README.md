...
that internal teams and clients actually use every day.
...
I split my time between leading Quicklizard's Technical Support team, building Support 
agents and internal tooling, and picking up tech-ops development work. 
...
- Build and own production LLM agent systems adopted across the Operations department, 
  cutting investigation time and letting the team handle more cases in parallel.
...
- Tier-1/2 support over Zendesk for an enterprise pricing and competitive intelligence
...
A Slack-native copilot answering operational questions for internal teams by
...
- **B.Sc. Software Engineering** — Bar-Ilan University, Ramat Gan (2023 – 2025)
